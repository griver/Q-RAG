...
HOP_SYSTEM_PROMPT = (
    ...
    "Sometimes the QUESTION is formatted as \"Entity >> Relation\" (e.g., \"Apple >> founder\"). In such cases, you must extract the exact entity that matches this relation (e.g., \"Steve Jobs\").\n"
...
if __name__ == "__main__":
    ...
    # KEY FIX: intermediate answers are used as chain-of-thought hints,
    # but the model must answer the ORIGINAL question — not just the last sub-question.
    #
    # Before fix:  prediction = last hop answer  (e.g. "Christopher Nolan", not "yes/no")
    # After fix:   model sees full reasoning chain + original question and synthesizes
