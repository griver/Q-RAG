...
from dataloaders.localsets.babilong.metrics_and_prompts import (
...
def evaluate_retriever_and_llm(r_tokenizer, retriever, llm_pipe, eval_dataloader, logger, args, outfile):
    ...
    for i, batch in enumerate(tqdm(eval_dataloader)):
        ...
        all_lens[id] = len(messages[1]['content'])
...
if __name__ == "__main__":
    ...
    answerer_model_name = "microsoft/Phi-3.5-mini-instruct" #"microsoft/Phi-4-mini-instruct"
    generate_kwargs = {
        "max_new_tokens": 25,
