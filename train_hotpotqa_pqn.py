...
cfg: DictConfig = load_config(name="training_hotpotqa")
...
env: QARetrievalEnv = instantiate(env_config.env)
env_test: QARetrievalEnv = instantiate(env_config.test_env)
...
for it in progress_bar:
    ...
    qf_loss, grad_norm = agent.update(
        train_batch.state, 
        train_batch.action, 
